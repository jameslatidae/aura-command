...
const Section: React.FC<{ title: string; children: React.ReactNode; defaultOpen?: boolean }> = ({ title, children, defaultOpen = false }) => {
    ...
    return (
        <div className="border-b" style={{ borderColor: activeTheme?.border || '#2d2d35' }}>
...
export const ButtonInspector: React.FC<{ widget: ButtonWidget }> = ({ widget }) => {
    const { dispatch, activeTheme } = useStore();
    ...
    return (
        <div className="flex flex-col p-4 space-y-6">
            <div className="flex justify-between items-center bg-black/20 p-2 rounded border" style={{ borderColor: activeTheme.border }}>
            ...
            <section>
                <div className="text-[10px] font-bold uppercase tracking-widest mb-3" style={{ color: activeTheme.textSecondary }}>General</div>
                ...
                <Field label="Presets">
                    <div className="flex gap-2">
                        <select className="inspector-input flex-1" id="presetSelect">
                            <option value="">Choose...</option>
                            {BUTTON_PRESETS.map(p => <option key={p.id} value={p.id}>{p.name}</option>)}
                        </select>
                        <button className="tb-btn" onClick={() => {
                            const val = (document.getElementById('presetSelect') as HTMLSelectElement).value;
            ...
            <section>
                <div className="text-[10px] font-bold uppercase tracking-widest mb-3" style={{ color: activeTheme.textSecondary }}>Geometry</div>
            ...
            <section>
                <div className="text-[10px] font-bold uppercase tracking-widest mb-3 flex items-center justify-between cursor-pointer" style={{ color: activeTheme.textSecondary }}>
                   Style & Shape
                </div>
            ...
            <section>
                <div className="text-[10px] font-bold uppercase tracking-widest mb-3" style={{ color: activeTheme.textSecondary }}>Action Configuration</div>
                <label className="flex items-center gap-2 text-[10px] mb-4 cursor-pointer">
                ...
                {widget.action.enabled && (
                    <div className="flex flex-col gap-3">
                        <div className="p-3 rounded border space-y-2" style={{ backgroundColor: 'rgba(0,0,0,0.2)', borderColor: activeTheme.border }}>
                        ...
                        <div className="h-px my-2" style={{ backgroundColor: activeTheme.border }} />
                        
                        <label className="flex items-center gap-2 text-[10px] mb-2 cursor-pointer" style={{ color: activeTheme.primary }}>
                        ...
                        {widget.action.expectReply && (
                            <div className="flex flex-col gap-3 p-3 rounded mb-2 border" style={{ backgroundColor: 'rgba(0,0,0,0.2)', borderColor: activeTheme.border }}>
